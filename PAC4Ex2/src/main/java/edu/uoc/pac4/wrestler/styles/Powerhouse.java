...
/**
 * Represents a wrestler with a Powerhouse style.
 */
public class Powerhouse extends Wrestler {

    /**
     * Constructs a Powerhouse wrestler with the specified attributes.
     *
    ...
    /**
     * Generates a string representation of the Powerhouse wrestler.
     *
